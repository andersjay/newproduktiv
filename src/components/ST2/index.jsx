  ...
  return (
    <Container w="100%" maxWidth="1220px" pb={50}>
      ...
      >
        ...
        <Text color="bg" fontSize={{base:'lg',md:'3xl' ,lg:'2xl'}} textAlign="left">
        ...
        <Table variant="simple" w={20} fontSize={20} >
          <Thead>
            <Tr>
              <Th fontSize={{base:'lg',md:'3xl' ,lg:'2xl'}} >Etapas</Th>
            </Tr>
          </Thead>
          <Tbody fontSize={{base:'lg',md:'3xl' ,lg:'2xl'}}>
            <Tr>
              <Td fontSize={{base:'lg',md:'2xl' ,lg:'2xl'}} color="bg">Guardar R$1.000,00</Td>
            </Tr>

            <Tr>
              <Td fontSize={{base:'lg',md:'2xl' ,lg:'2xl'}} color="bg">Guardar R$2.500,00</Td>
            </Tr>

            <Tr>
              <Td fontSize={{base:'lg',md:'2xl' ,lg:'2xl'}} color="bg">Guardar R$5.000,00</Td>
            </Tr>
            <Tr>
              <Td fontSize={{base:'lg',md:'2xl' ,lg:'2xl'}} color="bg">Guardar R$7.500,00</Td>
            </Tr>

            <Tr>
              <Td fontSize={{base:'lg',md:'2xl' ,lg:'2xl'}} color="bg">Guardar R$10.000,00</Td>
            </Tr>
          </Tbody>
        </Table>
