...
export function ST() {
  ...
  return (
    <Container w="100%" maxWidth="1220px" pt={50} pb={0}>
      <Center>
        <Text align="center" color="bg" fontSize="2xl" fontWeight={"bold"}>
          Também encontramos pessoas que tiveram pais rígidos, controladores,
          com expectativas muito altas em relação aos filhos...
        </Text>
      </Center>

      <Flex pt={20} pb={20} align="center" direction={{base:'column', lg:'row'}} justify="space-between" gap={6}>
